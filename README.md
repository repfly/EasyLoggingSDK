...
- **Memory Leak Detection** — periodic weak-reference checks with VC lifecycle awareness.
- **In-App Log Viewer** — searchable, filterable overlay with access-code protection for QA.
